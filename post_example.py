...
xml = '<enter><TimeFrame>60</TimeFrame><riskprofit>1,6573180485203945614502799242</riskprofit><PATTERN_PR_P>1,4826836853699624206297784113</PATTERN_PR_P><PATTERN_PR_T>0,555555555555556</PATTERN_PR_T><R0_P>0,0371113098844870204191553414</R0_P><R0_T>5</R0_T><R0_Way>100</R0_Way><R0_Pattern>1</R0_Pattern><R_Forecast_Pattern>9</R_Forecast_Pattern><R_Forecast_Percent>30</R_Forecast_Percent><R1_P>0,0516565398457082110149902958</R1_P><R1_T>9</R1_T><R1_Way>98</R1_Way><R1_Pattern>6</R1_Pattern><R2_Pattern>6</R2_Pattern><B0_P>-0,1230680850769305306580103958</B0_P><B0_T>50</B0_T><B0_Way>0</B0_Way><B0_Pattern>6</B0_Pattern><B_Forecast_Pattern>0</B_Forecast_Pattern><B_Forecast_Percent>100</B_Forecast_Percent><B1_Way>0</B1_Way><B1_Pattern>2</B1_Pattern><P0_P>-0,2475864502912130710710250825</P0_P><P0_T>100</P0_T><P0_Way>0</P0_Way><P0_Pattern>7</P0_Pattern><P_Forecast_Pattern>-1</P_Forecast_Pattern><P_Forecast_Percent>0</P_Forecast_Percent><P1_Way>0</P1_Way><P1_Pattern>4</P1_Pattern></enter>'
...
for i, child in enumerate(root):
    if i <= 100:
        ...
        r = requests.post(url=f'http://localhost:5000//result/post', data=l)
        print(r.text)
